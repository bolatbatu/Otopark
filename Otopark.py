...
arac1 = Arac("Toyota", "Corolla", "Siyah", "34 ABC 123")
arac2 = Arac("Audi", "A4", "Beyaz", "34 XYZ 987")

valet.arac_teslim_et(arac1)
valet.arac_teslim_et(arac2)

valet.arac_iade_et("34 ABC 123")
valet.arac_iade_et("34 DEF 456")
